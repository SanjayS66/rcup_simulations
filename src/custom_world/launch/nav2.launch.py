...
def generate_launch_description():
    ...
    tb3_gazebo_launch = os.path.join(
        get_package_share_directory('custom_world'),
        'launch',
        'turtlebot3_customworld.launch.py'
    )
    ...
    map_file = '/home/sanjay/ros2_workspaces/nav_turtlebot/src/custom_world/maps/slam_map.yaml'
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={'world': '/home/sanjay/Desktop/gazebo_custom_map/rcup_custom_arena_fixed_table.world'}.items()
    )
